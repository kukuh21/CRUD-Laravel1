    ...
    <div class="content-wrapper">
        ...
        <section class="content" id="dw">
            <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                    <form action="{{ route('pertanyaan.update', $pertanyaan->pertanyaan_id) }}" method="POST">
                      {{ csrf_field() }}
                      {{ method_field('PATCH') }}
                      <div class="card col-md-12">
                          <div class="form-group has-feedback{{ $errors->has('pertanyaan_nama') ? ' has-error': '' }}">
                            <label for="">Pertanyaan</label>
                            <input type="text" class="form-control" name="pertanyaan_nama" placeholder="Pertanyaan" value="{{ $pertanyaan->pertanyaan_nama }}">
